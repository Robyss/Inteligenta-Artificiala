...
# X_train, X_test, y_train, y_test = train_test_split(X_stop_lemma, y, test_size=0.2, shuffle=False)
...
print(f'Accuracy of Logistic Regression with C=2: {accuracy_score(y_valid, y_pred)}') 
# 0.7235987490979071
